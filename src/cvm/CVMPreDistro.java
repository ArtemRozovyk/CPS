 ...
 */
public class CVMPreDistro extends AbstractCVM {


    public CVMPreDistro(boolean isDistributed) throws Exception {
        super(isDistributed);
    }
    ...
    public CVMPreDistro() throws Exception {
        super();
    }
    ...
    public static void main(String[] args) {
        try {
            //while(true){
            CVMPreDistro c = new CVMPreDistro();
