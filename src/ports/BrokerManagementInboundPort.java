    ...
    public void subscribe(String topic, String inboundPortURI) throws Exception {
        this.owner.runTask(
                new AbstractComponent.AbstractTask() {
                    ...
                    public void run() {
                        try {
                            ((Broker) this.getTaskOwner()).subscribe(topic, inboundPortURI);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
    ...
    public void subscribe(String[] topics, String inboutPortURI) throws Exception {
        this.owner.runTask(
                new AbstractComponent.AbstractTask() {
                    ...
                    public void run() {
                        try {
                            ((Broker) this.getTaskOwner()).subscribe(topics, inboutPortURI);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
    ...
    public void subscribe(String topic, MessageFilterI filter, String inboutPortURI) throws Exception {
        this.owner.runTask(
                new AbstractComponent.AbstractTask() {
                    ...
                    public void run() {
                        try {
                            ((Broker) this.getTaskOwner()).subscribe(topic, filter, inboutPortURI);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
    ...
    public void unsubscribe(String topic, String inboundPortURI) throws Exception {
        this.owner.runTask(
                new AbstractComponent.AbstractTask() {
                    ...
                    public void run() {
                        try {
                            ((Broker) this.getTaskOwner()).unsubscribe(topic, inboundPortURI);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
